...
void loop() {
  ...
  control(teststr[0]);
  speed = dxl.getPresentVelocity(DXL_ID, UNIT_RPM);
  Serial.print(" ");
  Serial.print(speed);
  Serial.print("\n");
}
...
void control(char choice) {
  switch(choice) {
    case '1':
      dxl.setGoalVelocity(DXL_ID, 10, UNIT_RPM);
      digitalWrite(LED_BUILTIN, HIGH);
      break;
    case '2':
      dxl.setGoalVelocity(DXL_ID, 30, UNIT_RPM);
      digitalWrite(LED_BUILTIN, LOW);
      break;
    case '3':
      dxl.setGoalVelocity(DXL_ID, 50, UNIT_RPM);
      digitalWrite(LED_BUILTIN, HIGH);
      break;
    default:
